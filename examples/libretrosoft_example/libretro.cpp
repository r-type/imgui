...
unsigned int rwidth  = BASE_WIDTH;
unsigned int rheight = BASE_HEIGHT;
...
unsigned char *retrofont;
int rfontx=-1,rfonty=-1;
...
void retro_get_system_info(struct retro_system_info *info)
{
   ...
   info->library_name     = "imgui Libretro";
